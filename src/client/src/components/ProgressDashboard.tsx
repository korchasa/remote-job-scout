...
export function ProgressDashboard(
  { progress, onPauseResume, onStop }: ProgressDashboardProps,
) {
  ...
  const getStageProgress = (stageId: number) => {
    ...
    switch (stageId) {
      case 1:
        return progress.totalJobs > 0
          ? (progress.processedJobs / progress.totalJobs) * 100
          : 0;
      case 2:
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <div
                ...
                data-testid="text-processed-jobs"
              >
            ...
            <div>
              ...
              <div
                ...
                data-testid="text-filtered-jobs"
              >
            ...
            <div>
              ...
              <div
                ...
                data-testid="text-enriched-jobs"
              >
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className="font-mono text-sm"
                data-testid="text-processing-speed"
              >
